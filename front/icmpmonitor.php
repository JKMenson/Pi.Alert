	...
	?>
	  ...
	  <div class="box" id="clients">
              ...
              <div class="box-header with-border">
                <h3 class="box-title"><?=$pia_lang['Device_Shortcut_OnlineChart_a'];?><span class="maxlogage-interval">Device status as per the graph</span> <?=$pia_lang['Device_Shortcut_OnlineChart_b'];?></h3>
	      </div>
