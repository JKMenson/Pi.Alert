...
<head>
  ...
  <title>Home Network Security Monitoring System <?php echo gethostname(); ?></title>
  i<!-- Tell the browser to be responsive to screen width -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="." class="logo">
      ...
      <span class="logo-lg">Home Network</b></span>
    </a>
            ...
            <ul class="dropdown-menu" style="width: 240px;">
              ...
              <li class="user-footer">
                <div class="custom-menu-icon-links">
                  <a href="https://github.com/JKMenson/pi.alert" class="btn btn-default" target="blank"><i class="fa-brands fa-github"></i></a>
                </div>
                <div class="custom-menu-icon-links">
		  <a href="https://github.com/JKMenson/pi.alert
" class="btn btn-default" target="blank"><i class="fa-regular fa-heart text-maroon"></i></a>
                </div>
                <div class="custom-menu-icon-links">
                  <a href="https://github.com/JKMenson/pi.alert" class="btn btn-default" target="blank"><i class="fa-solid fa-house"></i></a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="logo" style="width:60%; margin:auto;">
           <a href="./"><img src="img/logo.png" class="img-responsive" alt="Pi.Alert Logo"/></a>
        </div>
